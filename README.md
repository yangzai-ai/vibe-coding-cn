...
**译者：** [tukuaiai](https://github.com/tukuaiai), [https://x.com/123olp](https://x.com/123olp)
...
- [**原始中文版文档.md**](./原始中文版文档.md) - Vibe Coding 指南的原始中文版本。
- [**系统提示词构建 105 原则.md**](./系统提示词构建%20105%20原则.md) - 构建高效、可靠的AI系统提示词的105条核心原则。
- [**经验.md**](./经验.md) - 包含编程原则、架构思想和技术栈（如微服务、Redis）的经验总结。
- [**初始化.md**](./初始化.md) - 变量命名与维护规则、文件命名规范、编码规范及文件夹结构设计指南。
- [**经验收集.md**](./经验收集.md) - AI开发最佳实践，包括伪代码到代码的转换流程和系统提示词优化技巧。
-  **[**（必看！）标准项目开发目录结构参考.md**](./（必看！）标准项目开发目录结构参考.md)**   - Python项目标准目录结构参考，涵盖Web应用、数据科学、微服务等场景的最佳实践。
